...
public class TelecommandeTEST extends SurfaceView implements Callback, View.OnTouchListener {
    ...
    //Constructeurs
    public TelecommandeTEST(Context context) {
        super(context);
    ...
    public TelecommandeTEST(Context context, AttributeSet attrs) {
        super(context, attrs);
        getHolder().addCallback(this);
        getHolder().setFormat(PixelFormat.TRANSPARENT);
        setOnTouchListener(this);
    ...
    public TelecommandeTEST(Context context, AttributeSet attrs, int defStyleAttr) {
